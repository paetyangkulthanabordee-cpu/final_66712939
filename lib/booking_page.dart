...
//เพิ่ม override //
  ...
  Future saveBooking() async {
    ...
    var url = Uri.parse(
        "http://localhost/final_66712939/php_api/add_booking.php");
    ...
    var response = await http.post(
      ...
      body: {
        ...
        "eq_name": nameController.text,
        "detail": dateController.text,
        "num": startController.text        
    ...
    if (data['status'] == "success") {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("อุปกรณ์ไม่ว่าง เวลาชนกัน")),
      );
...
Widget build(BuildContext context) {
  ...
  String roomName = widget.room['eq_name'] ?? "อุปกรณ์";
        ...
        child: Column(
          ...
          children: [
            ...
            ClipRRect(
              ...
              child: Image.network(
                "http://localhost/final_66712939/php_api/images/$roomImage",
